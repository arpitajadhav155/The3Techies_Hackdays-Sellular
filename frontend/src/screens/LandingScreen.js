  ...
  return (
    <Box>
      ...
      >
        <Grid item xs={12} md={6}>
          ...
          >
            <Typography
              ...
              component="div"
            >
              <strong>Competitions, Fests, Workshops, & more!</strong>
            </Typography>
        ...
        <Grid item xs={12} md={6}>
          <img
            src="https://res.cloudinary.com/dwdntz8et/image/upload/v1679221543/63c7ae771c4a1_competitions_hero_jliwmy.png"
            alt="hero"
      ...
      <Box sx={{ px: 4, py: 5 }}>
        <Grid container spacing={5}>
          <Grid item xs={12} md={6}>
            <img
              src="https://res.cloudinary.com/dwdntz8et/image/upload/v1679232914/profile_ueajd0.png"
              alt="Portfolio"
      ...
      <Box sx={{ px: 4, py: 5 }}>
        <Grid container spacing={5}>
          ...
          <Grid item xs={12} md={6}>
            <img
              src="https://res.cloudinary.com/dwdntz8et/image/upload/v1679232913/Chat_t1zwa9.png"
      ...
      <Box sx={{ px: 4, py: 5 }}>
        <Grid container spacing={5}>
          <Grid item xs={12} md={6}>
            <img
              src="https://res.cloudinary.com/dwdntz8et/image/upload/v1679232914/Event_ucsyqd.png"
      ...
      >
        &copy; {new Date().getFullYear()} Hackth00ns. All rights reserved.
      </Box>
    </Box>
  );
}
